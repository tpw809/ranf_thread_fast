"""MetricMaterial Class Definition.
...
class MetricMaterial:
    ...
    def from_dict(cls, input_dict):
        ...
        - Ssu_mpa:
        """
        assert input_dict['type'] == 'MetricMaterial'
...
def main() -> None:
    ...
    stainless_steel_18_8 = MetricMaterial(
    ...
    mat_copy = MetricMaterial.from_dict(output_dict)
    print(mat_copy)
    ...
    test_input_dict_mat = MetricMaterial.from_dict(input_dict)
